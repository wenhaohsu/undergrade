...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 17 16:56:20 2020
...
ECG=pd.DataFrame({'act':ECG_data.ACT,'ill':ECG_data.Illuminance,'var':ECG_data.VAR
...
combine=pd.merge(ECG,TD1,on='Time',how='outer')
