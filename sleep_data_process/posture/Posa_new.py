...
def get_post_time(posture):
    ...
    for i in range(len(posture)):
        if posture[i]==1:
            ...
            prone+=1/6
    return supine,right,left,prone
...
post_time=get_post_time(sheetX['Posture2'])
list_post='Supine:{a},Right:{b},Left:{c},Prone:{d}'\
.format(a=post_time[0],b=post_time[1],c=post_time[2],d=post_time[3])
#print('Supine:'post_time[0])
#print('Right:'post_time[1])
#,'Left:'post_time[2],'Prone:'post_time[3])